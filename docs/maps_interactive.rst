...
.. only:: html
    ...
    .. raw:: html
        ...
        <option value="bangkok_ind_district_health_centres_rate_area">Health centers (n = 68), by district per km²: health centers</option>
        <option value="bangkok_ind_district_health_centres_rate_population">Health centers (n = 68), by district per 10,000 population: health centers</option>
        <option value="bangkok_ind_district_health_centres_rate_household">Health centers (n = 68), by district per 10,000 household: health centers</option>
        ...
        <option value="bangkok_ind_district_outpatients_combined_diseases_rate_area">Outpatient numbers for 68 Health Centers per km²: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_district_outpatients_combined_diseases_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_district_outpatients_combined_diseases_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_district_outpatients_diabetes">Outpatient numbers for 68 Health Centers: diabetes (2018)</option>
        <option value="bangkok_ind_district_outpatients_diabetes_rate_area">Outpatient numbers for 68 Health Centers per km²: diabetes (2018)</option>
        <option value="bangkok_ind_district_outpatients_diabetes_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: diabetes (2018)</option>
        <option value="bangkok_ind_district_outpatients_diabetes_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: diabetes (2018)</option>
        ...
        <option value="bangkok_ind_district_outpatients_hypertension_rate_area">Outpatient numbers for 68 Health Centers per km²: hypertension (2018)</option>
        <option value="bangkok_ind_district_outpatients_hypertension_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: hypertension (2018)</option>
        <option value="bangkok_ind_district_outpatients_hypertension_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: hypertension (2018)</option>
        ...
        <option value="bangkok_ind_district_outpatients_mental_health_rate_area">Outpatient numbers for 68 Health Centers per km²: mental and behavioural disorders (2018)</option>
        <option value="bangkok_ind_district_outpatients_mental_health_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: mental and behavioural disorders (2018)</option>
        <option value="bangkok_ind_district_outpatients_mental_health_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: mental and behavioural disorders (2018)</option>
        ...
        <option value="bangkok_ind_fire_incidence_rate_area">สถิติอัคคีภัยจำแนกตามพื้นที่เขตในกรุงเทพมหานคร ปี 2561 (Fire Incidence in Bangkok 2018) per km²: fire incidence</option>
        <option value="bangkok_ind_fire_incidence_rate_population">สถิติอัคคีภัยจำแนกตามพื้นที่เขตในกรุงเทพมหานคร ปี 2561 (Fire Incidence in Bangkok 2018) per 10,000 population: fire incidence</option>
        <option value="bangkok_ind_fire_incidence_rate_household">สถิติอัคคีภัยจำแนกตามพื้นที่เขตในกรุงเทพมหานคร ปี 2561 (Fire Incidence in Bangkok 2018) per 10,000 household: fire incidence</option>
        <option value="bangkok_ind_subdistrict_health_centres">Health centers (n = 68), by subdistrict: health centers</option>
        <option value="bangkok_ind_subdistrict_health_centres_rate_area">Health centers (n = 68), by subdistrict per km²: health centers</option>
        <option value="bangkok_ind_subdistrict_health_centres_rate_population">Health centers (n = 68), by subdistrict per 10,000 population: health centers</option>
        <option value="bangkok_ind_subdistrict_health_centres_rate_household">Health centers (n = 68), by subdistrict per 10,000 household: health centers</option>
        ...
        <option value="bangkok_ind_subdistrict_outpatients_combined_diseases_rate_area">Outpatient numbers for 68 Health Centers per km²: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_combined_diseases_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_combined_diseases_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: vital diseases (combined; 2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_diabetes">Outpatient numbers for 68 Health Centers: diabetes (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_diabetes_rate_area">Outpatient numbers for 68 Health Centers per km²: diabetes (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_diabetes_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: diabetes (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_diabetes_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: diabetes (2018)</option>
        ...
        <option value="bangkok_ind_subdistrict_outpatients_hypertension_rate_area">Outpatient numbers for 68 Health Centers per km²: hypertension (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_hypertension_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: hypertension (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_hypertension_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: hypertension (2018)</option>
        ...
        <option value="bangkok_ind_subdistrict_outpatients_mental_health_rate_area">Outpatient numbers for 68 Health Centers per km²: mental and behavioural disorders (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_mental_health_rate_population">Outpatient numbers for 68 Health Centers per 10,000 population: mental and behavioural disorders (2018)</option>
        <option value="bangkok_ind_subdistrict_outpatients_mental_health_rate_household">Outpatient numbers for 68 Health Centers per 10,000 household: mental and behavioural disorders (2018)</option>
